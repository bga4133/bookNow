    ...
    <div>
		...
		<div class="container pagecontainer offset-0">	
			...
			<div class="col-md-8 details-slider">
				...
				<div id="inner">
					...
					<div id="pager-wrapper">
						<div id="pager">
							<img src="../../../src/images/background2.jpg" width="120" height="68" alt=""/>
							<img src="../../../src/images/background2.jpg" width="120" height="68" alt=""/>
							<img src="../../../src/images/background2.jpg" width="120" height="68" alt=""/>
							<img src="../../../src/images/background2.jpg" width="120" height="68" alt=""/>
							<img src="../../../src/images/background2.jpg" width="120" height="68" alt=""/>
			...
			<div class="col-md-4 detailsright offset-0">
				<div class="padding20">
					<h3 class="lh1">Nombre del hotel</h3>
				</div>
				
				<div class="line3"></div>
				
				<div class="hpadding20">
					<h3 class="opensans slim green2">Uno de los bestsellers en Medellín</h3>
				</div>
				
				<div class="line3 margtop20"></div>
				
				<div class="col-md-6 bordertype1 padding20">
					<span class="opensans size30 bold grey2">8,1</span><br/>
				</div>
				...
				<div class="tab-content4" >
					...
					<div id="roomrates" class="tab-pane fade active in">
						...
						<div class="padding20">
							...
							<div class="col-md-8 offset-0">
								<div class="col-md-8 mediafix1">
									<h5 class="opensans dark bold margtop1 lh2">Standard Double room</h5>
						...
						<div class="padding20">
							...
							<div class="col-md-8 offset-0">
								<div class="col-md-8">
									<h5 class="opensans dark bold margtop1 lh2">Double Room with Town View</h5>
						...
						<div class="padding20">
							...
							<div class="col-md-8 offset-0">
								<div class="col-md-8">
									<h4 class="opensans dark bold margtop1 lh2">Family Suite</h4>
						...
						<div class="padding20">
							...
							<div class="col-md-8 offset-0">
								<div class="col-md-8">
									<h4 class="opensans dark bold margtop1 lh2">Superior, Sea View</h4>
									Max Occupancy: 3 adults
									<ul class="hotelpreferences margtop10">
										<li class="icohp-internet"></li>
										<li class="icohp-air"></li>
